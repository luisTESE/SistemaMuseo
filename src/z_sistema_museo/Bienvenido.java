...
public class Bienvenido extends javax.swing.JFrame {
    ...
    public static void Conecion() {
        try {
            ...
            String connectionURL = "jdbc:sqlserver://localhost:1433;databaseName=museo;user=Museo;password=321;";
    ...
    private void initComponents() {
        ...
        jMenuItem3.setText("Consulta y Eliminar");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(contenedor, javax.swing.GroupLayout.DEFAULT_SIZE, 657, Short.MAX_VALUE)
        );
